...
SYSTEM_PROMPT_V1 = (
    ...
    "   - LEAF PRIORITET: ako ime iz upita tačno odgovara nekoj LEAF kategoriji, "
    "biraj `search_products` za taj leaf — i kad postoji sličan PARENT (npr. "
    "'Mobilni telefoni' je leaf → `search_products`, NE pregled parenta 'Mobiteli').\n"
