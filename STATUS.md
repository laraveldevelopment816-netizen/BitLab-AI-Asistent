...
- [x] Lean prompt u SYSTEM_PROMPT_V1 — rvpr (spojen sa frtl) <!-- id:rvpr effort:3 pct:65 -->
...
- [x] Forsiran tool calling — respond_to_user + tool_choice <!-- id:frtl effort:4 pct:75 -->
...
- [x] Smoke eyeball — scripts/smoke.py <!-- id:setp effort:2 pct:44 -->
...
- [x] Eval regresija iter17 — dijagnoza <!-- id:i17r effort:4 pct:75 -->
...
- [x] Faza 0 — Ralph petlja + TDD eval framework infra <!-- id:fz00 effort:4 pct:75 -->
