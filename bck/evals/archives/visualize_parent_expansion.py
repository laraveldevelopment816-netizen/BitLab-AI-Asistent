...
Output: evals/runs/parent-expansion-{YYYYMMDD-HHMMSS}.html (configurabilno --out)
...
def default_out_path() -> Path:
    """Default output: evals/runs/parent-expansion-{TS}.html."""
...
def main() -> int:
    ...
    p.add_argument("--out", default=None, help="Output HTML path (default: evals/runs/parent-expansion-{TS}.html)")
